...
{
    $queryCountLike = "SELECT COUNT(eval.ideval) as counter FROM eval JOIN idea ON idea.ididea = eval.ideaid WHERE eval.eval = 1 ";
...
{
    $queryCountDislike = "SELECT COUNT(eval.ideval) as counter FROM eval JOIN idea ON idea.ididea = eval.ideaid WHERE eval.eval = 0";
